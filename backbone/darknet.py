...
__all__ = ['DarkNet', 'darknet_ref', 'darknet_tiny', 'darknet19', 'darknet_tiny_h']
...
def get_darknet(version,
    ...
    if version == 'ref':
        ...
        channels = [[8], [16], [8, 64, 8, 64], [16, 128, 16, 128], [32, 256, 32, 256, 64]]
        odd_pointwise = True
        avg_pool_size = 14
        cls_activ = False
...
def darknet_tiny_h(**kwargs):
    ...
    root : str, default '~/.torch/models'
        Location for keeping the model parameters.
    """
    return get_darknet(version="tiny-h", model_name="darknet_tiny_h", **kwargs)
